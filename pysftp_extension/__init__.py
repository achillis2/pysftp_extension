...
from pysftp_extension.exceptions import (CredentialException, ConnectionException,
                               HostKeysException)
from pysftp_extension.helpers import (st_mode_to_int, WTCallbacks, path_advance,
...
class Connection(object):   # pylint:disable=r0902,r0904
    ...
    def __init__(self, host, username=None, private_key=None, password=None,
                 ...
                 cnopts=None, default_path=None, disabled_algorithms=None):
        ...
        self._start_transport(host, port, disabled_algorithms)
    ...
    def _start_transport(self, host, port, disabled_algorithms):
